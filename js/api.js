...
const API = {
    ...
    VIDEO_MODELS: {
        ...
        'kling-3.0-pro-text-to-video':   '/kwaivgi/kling-v3.0-pro/text-to-video',
        'kling-3.0-pro-image-to-video':  '/kwaivgi/kling-v3.0-pro/image-to-video',
        'kling-2.6-pro-text-to-video':   '/kwaivgi/kling-v2.6-pro/text-to-video',
    ...
    VIDEO_PRICING: {
        ...
        'kling-3.0-pro-text-to-video':  { flat: 0.84, flatNoAudio: 0.56 },
        'kling-3.0-pro-image-to-video': { flat: 0.84, flatNoAudio: 0.56 },
        'kling-2.6-pro-text-to-video':  { flat: 0.56, flatNoAudio: 0.38 },
